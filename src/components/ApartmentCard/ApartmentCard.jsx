  ...
  return (
    ...
    <Link to={`/${props.id}`}>
      ...
      <div className="apartment">
        ...
        <img src={props.imageUrl} alt={props.title} /> {/* Affiche l'image avec l'URL et le titre fournis en props */}
        {/* Sous-titre (titre de l'appartement) */}
        <div className="apartment__subtitle">{props.title}</div> {/* Affiche le titre de l'appartement */}
      </div>
    </Link>
  );
}
